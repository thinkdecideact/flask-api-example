...
app.register_blueprint(store_bp_v1, url_prefix='/api/v1/store')
app.register_blueprint(store_bp_v2, url_prefix='/api/v2/store')
app.register_blueprint(store_bp_v3, url_prefix='/api/store')
app.register_blueprint(store_bp_v4, url_prefix='/api/v4/store')
app.register_blueprint(store_bp_v5, url_prefix='/api/store')
